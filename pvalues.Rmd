...
# 
# d <- fread(data)
d <- fread("https://github.com/statwonk/aact/blob/master/results_outcome_analysis.txt")
...
[^peculiar-p-value-journals]:[_Journal of Experimental Psychology: General (JEPG)_, _Journal of Personality and Social Psychology_ (JPSP), and _Psychological Science_ (PS).]
